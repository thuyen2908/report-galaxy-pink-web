...
Locator: locator('.MuiDataGrid-row').locator('[data-field="ticketTotals"]').filter({ hasText: '$55.47' }).first()
...
Call log:
  ...
  - waiting for locator('.MuiDataGrid-row').locator('[data-field="ticketTotals"]').filter({ hasText: '$55.47' }).first()
