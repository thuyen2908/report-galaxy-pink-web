...
- Location: dist/bdd/ticket-adjustment.feature.spec.js:484:3
...
Locator: locator('.MuiDataGrid-row').locator('[data-field="ticketTotals"]').filter({ hasText: '$51.51' }).first()
...
Call log:
  ...
  - waiting for locator('.MuiDataGrid-row').locator('[data-field="ticketTotals"]').filter({ hasText: '$51.51' }).first()
