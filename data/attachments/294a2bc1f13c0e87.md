...
Locator:  locator('.MuiDataGrid-row [role="gridcell"][data-field="payment"]').first()
Expected: "$232.26"
Received: "$228.70"
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.MuiDataGrid-row [role="gridcell"][data-field="payment"]').first()
    14 × locator resolved to <div tabindex="-1" role="gridcell" title="$228.70" aria-colspan="1" data-colindex="4" aria-colindex="5" data-field="payment" class="MuiDataGrid-cell MuiDataGrid-cell--textRight">$228.70</div>
       - unexpected value "$228.70"
