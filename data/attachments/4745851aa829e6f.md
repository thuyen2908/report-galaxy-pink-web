...
- Location: dist/bdd/payroll.feature.spec.js:254:3
...
Locator: locator('table tbody tr').filter({ hasText: 'Net Non-Cash Tip:' }).first().locator('td').nth(1)
...
Call log:
  ...
  - waiting for locator('table tbody tr').filter({ hasText: 'Net Non-Cash Tip:' }).first().locator('td').nth(1)
