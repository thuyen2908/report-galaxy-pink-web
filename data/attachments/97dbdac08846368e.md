...
- Name: closed-ticket.feature.spec.js >> Closed Ticket >> Update GC balance when selling an add-on gift card and then voiding the ticket
- Location: dist/bdd/closed-ticket.feature.spec.js:333:3
...
Locator: locator('div.xQueueList').getByText('Isabella', { exact: true })
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for locator('div.xQueueList').getByText('Isabella', { exact: true })
            ...
            - tabpanel [ref=e87]:
              ...
              - list [ref=e99]:
                ...
                - listitem [ref=e959] [cursor=pointer]:
                  ...
                  - generic [ref=e969]:
                    - img [ref=e970]
                    - generic [ref=e974]: 07:06:04 AM
                  - generic [ref=e976]:
                    - generic [ref=e978]: T = 6.00
                    - generic [ref=e980]: C = 0.0
                    - generic [ref=e982]: L = 6.00
