...
- Name: closed-ticket.feature.spec.js >> Closed Ticket >> Reopen ticket to add service and make payment Credit
- Location: dist/bdd/closed-ticket.feature.spec.js:214:3
...
Locator: locator('div.xQueueList').getByText('Julia', { exact: true })
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for locator('div.xQueueList').getByText('Julia', { exact: true })
