...
- Name: closed-ticket.feature.spec.js >> Closed Ticket >> Reopen ticket to void ticket
- Location: dist/bdd/closed-ticket.feature.spec.js:245:3
...
Locator: locator('div.xQueueList').getByText('Daisy', { exact: true })
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for locator('div.xQueueList').getByText('Daisy', { exact: true })
